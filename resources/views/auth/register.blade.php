...
<div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-gray-50">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-6 shadow-xl rounded-xl border border-gray-200 sm:px-10">
            <h2 class="text-2xl font-bold text-gray-900 mb-8 text-center">Crear Cuenta</h2>
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-6" >
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        {{-- Icono de ojo para mostrar/ocultar contraseña --}}
                        <button type="button" 
                                onclick="togglePasswordVisibility('password_confirmation', 'password-confirm-eye-icon')" 
                                class="absolute inset-y-0 right-0 pr-3 flex items-center">
                            <svg id="password-confirm-eye-icon" class="h-5 w-5 text-gray-400 hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.59 6.59m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                            </svg>
                        </button>
                    </div>
