            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <select id="status" 
                            ...
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                            required>
                        <option value="activo" {{ old('status', $role->status) == 'activo' ? 'selected' : '' }} class="text-green-700">
                            Activo
                        </option>
                        <option value="inactivo" {{ old('status', $role->status) == 'inactivo' ? 'selected' : '' }} class="text-red-700">
                            Inactivo
                        </option>
                    </select>
                    @error('status')
                    ...
                    <div class="mt-3 space-y-2">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-600"><strong>Activo:</strong> Rol disponible para usuarios</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full bg-red-500"></div>
                            <span class="text-sm text-gray-600"><strong>Inactivo:</strong> Rol deshabilitado</span>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $("form").validate({
            ...
            messages: {
                ...
                status: {
                    required: "Por favor seleccione el estado del rol"
                }
            },
        });
    });
